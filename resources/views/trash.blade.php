...
<body>
    ...
    @if (Session::get('success'))
        <p style="adding: 5px 10px; background: green; color: white; margin: 10px;">
    ...
    <ol>
        ...
        <li>
            ...
            <a href="{{route('permanent', $student['id'])}}" style="background:  orange; color: white;">Hapus Permanent</a>
        </li>
    </ol>
    @endforeach
</body>
